...
ADDON_SCRIPT="https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/runtipi.sh)"
MIGRATION_EOF
