...
ADDON_SCRIPT="https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/dockge.sh)"
MIGRATION_EOF
