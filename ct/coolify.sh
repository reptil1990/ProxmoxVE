...
ADDON_SCRIPT="https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
