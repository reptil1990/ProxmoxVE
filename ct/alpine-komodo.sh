...
ADDON_SCRIPT="https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
