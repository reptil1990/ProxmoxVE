...
ADDON_SCRIPT="https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
