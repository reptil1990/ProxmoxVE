...
# upstream   https://github.com/reptil1990/ProxmoxVE.git (fetch)
# upstream   https://github.com/reptil1990/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/reptil1990/ProxmoxVE"
echo ""
