...
source <(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/ct/${service}.sh)
