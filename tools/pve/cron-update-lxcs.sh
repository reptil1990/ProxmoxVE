...
#
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main/tools/pve/cron-update-lxcs.sh)"

set -euo pipefail

REPO_URL="https://raw.githubusercontent.com/reptil1990/ProxmoxVE/main"
